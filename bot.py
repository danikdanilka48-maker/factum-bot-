...
1. МОВА — бездоганна українська:
   ...
   - НЕ калькуй з російської: пиши "зафіксовано" (не "відмічено"), "брати участь" (не "приймати участь"), "через" (не "у зв'язку з"), "попри" (не "незважаючи на")
   - Правильні відмінки, узгодження, розділові знаки
   - Після цифр і абревіатур правильно розставляй крапки та коми
...
3. СТИЛЬ:
   - 1-3 речення залежно від кількості фактів в оригіналі
