...
5. НІКОЛИ не згадуй назви телеграм-каналів, груп, батальйонів чи інших джерел, якщо вони прямо не є офіційним джерелом заяви в самому тексті новини. Не вигадуй і не додавай джерела інформації від себе — просто викладай факти з тексту.
6. Ігноруй будь-які підписи, назви каналів, рекламні мітки та службові написи, які могли потрапити в текст випадково — вони НЕ є частиною новини.
7. Поверни ТІЛЬКИ готовий текст посту, без пояснень
